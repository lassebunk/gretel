...
class HelperMethodsTest < ActionView::TestCase
  ...
  test "semantic breadcrumb" do
    breadcrumb :with_root
    assert_dom_equal %Q{<div class="breadcrumbs" itemtype="http://schema.org/BreadcrumbList"><span itemscope="#{itemscope_value}" itemtype="http://schema.org/ListItem"><a href="/" itemprop="url"><span itemprop="name">Home</span></a></span> &rsaquo; <span itemscope="#{itemscope_value}" itemtype="http://schema.org/ListItem"><span class="current" itemprop="name">About</span></span></div>},
  ...
  test "custom semantic container and fragment tags" do
    breadcrumb :basic
    assert_dom_equal %Q{<c class="breadcrumbs" itemtype="http://schema.org/BreadcrumbList"><f itemscope="#{itemscope_value}" itemtype="http://schema.org/ListItem"><a itemprop="url" href="/"><span itemprop="name">Home</span></a></f> &rsaquo; <f class="current" itemscope="#{itemscope_value}" itemtype="http://schema.org/ListItem"><span itemprop="name">About</span><meta itemprop="url" content="http://test.host/about" /></f></c>},
