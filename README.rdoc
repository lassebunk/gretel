...
In <code>config/initializers/breadcrumbs.rb</code>:
  ...
  Gretel::Crumbs.layout do
    ...
    crumb :category do |category|
      ...
      while parent_category = category.parent_category
        link parent_category.name, parent_category
      end
    end
...
In <code>app/views/layouts/application.html.erb</code>:
  ...
  <%= breadcrumb :use_microformats => true,
...
* Currently breaks devise mailers because of the <code>controller</code> method in <code>lib/gretel/helper_methods</code>. Can anybody help fixing this?
